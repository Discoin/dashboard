...
[![Build Status](https://github.com/discoin/dashboard/workflows/CI/badge.svg)](https://github.com/discoin/dashboard/actions)
[![XO code style](https://img.shields.io/badge/code_style-XO-5ed9c7.svg)](https://github.com/xojs/xo)
[![codecov](https://codecov.io/gh/discoin/dashboard/branch/master/graph/badge.svg)](https://codecov.io/gh/discoin/dashboard)
...
The CI will upload the coverage information to [CodeCov](https://codecov.io) which can be [viewed here](https://codecov.io/gh/discoin/dashboard).
